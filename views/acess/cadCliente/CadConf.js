...
export default function CadConf (props) {
    ...
    return (
        <View style={{flexDirection: 'column', flex: 1, alignItems: 'center', marginTop: 70}}>
            ...
            <Text style={{width: '90%', textAlign: 'center', padding: 25, fontSize: 15, fontWeight: 'bold'}}>Um link de confirmação foi enviado para o e-mail cadastrado.</Text>
