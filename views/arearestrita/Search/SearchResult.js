  ...
  const Item = ({ item, onPress }) => (
    <TouchableOpacity
      onPress={()=>props.navigation.navigate('DriverProfile',
                   {itens:props.route.params.itens, ajuda:props.route.params.ajuda,
                    escada:props.route.params.escada, codMotorista:item.id, nome:item.nome,
                    origem:props.route.params.origem, destino:props.route.params.destino,
                    preco:props.route.params.preco, duracao:props.route.params.duracao,
